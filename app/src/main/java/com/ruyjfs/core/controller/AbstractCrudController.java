...
public abstract class AbstractCrudController<T> {
  ...
  @Autowired
  protected CrudServiceInterface<T> service;
  ...
  @GetMapping("/{id}")
  public ResponseEntity<Object> show(@PathVariable final String id) {
  ...
  @PutMapping("/{id}")
  public ResponseEntity<Object> save(@PathVariable final String id, @Validated @RequestBody T data) {
  ...
  @PatchMapping("/{id}")
  public ResponseEntity<Object> update(@PathVariable final String id, @Validated @RequestBody T data) {
